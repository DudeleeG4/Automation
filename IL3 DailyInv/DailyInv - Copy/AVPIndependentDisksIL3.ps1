...
foreach ($disk in $SubFinal)
{
	...
	$info.Name = $disk.Name
	$info.vCenter = $disk.Client.ConnectivityService.ServerAddress
...
{
Send-MailMessage -To "noc@ukcloud.com" -From "AVPIndependentDisksIL3@skyscapecloud.com" -Bcc "mharris@skyscapecloud.com" -Subject "VMDKs stuck to AVPs $gDate" -SmtpServer rly00001i2 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #$outfile,$outfile1 
}
Else {
Send-MailMessage -To "noc@ukcloud.com" -From "AVPIndependentDisksIL3@skyscapecloud.com" -Bcc "mharris@skyscapecloud.com" -Subject "VMDKs stuck to AVPs $gDate" -SmtpServer 10.72.81.30 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #-Attachments $outfile,$outfile1
}
