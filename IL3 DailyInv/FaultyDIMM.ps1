...
$ccc = Get-UcsFault | Where-Object {$_.Severity -like "critical" -or $_.Severity -like "major" -or $_.Severity -like "minor" -and $_.Descr -like "*DIMM*" -or $_.Descr -like "DDR"} | Sort-Object UCS,Created,Severity,Descr | Select-Object -Property Ucs,Severity,Occur,DN,Descr,Created,LastTransition,Code,Cause
#$ccc.UCS
...
If ($env:USERDOMAIN -like "*il2*")
{
Send-MailMessage -To "noc@ukcloud.com" -From "UCSFaultsIL2@ukcloud.com" -Subject "UCS DIMM Faults $gDate" -SmtpServer rly00001i2 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #$outfile,$outfile1 
}
Else {
Send-MailMessage -To "noc@ukcloud.com" -From "UCSFaultsIL3@ukcloud.com" -Subject "UCS DIMM Faults $gDate" -SmtpServer 10.72.81.30 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #-Attachments $outfile,$outfile1
}
