...
If ($env:USERDOMAIN -like "*il2*")
{
Send-MailMessage -To "noc@ukcloud.com" -From "HostConfigIssuesIL2@ukcloud.com" -Subject "Host Config Issues $gDate" -SmtpServer rly00001i2 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #$outfile,$outfile1 
}
Else {
Send-MailMessage -To "noc@ukcloud.com" -From "HostConfigIssuesIL3@ukcloud.com" -Subject "Host Config Issues $gDate" -SmtpServer 10.72.81.30 -Body $HBody -BodyAsHtml  -Attachments $OutputFile,$OutputFileCSV #-Attachments $outfile,$outfile1
}
