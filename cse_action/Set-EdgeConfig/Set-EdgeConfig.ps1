...
PS C:\> .\Set-EdgeConfig.ps1 -Name "nft000xxi2-1" -Path "C:\Scripts\CSE\EdgeXML\nft000xxi2-1\nft000xxi2-1_VPN_SR.xml"
	
.EXAMPLE
PS C:\> Connect-CIServer vcloud
PS C:\> .\Set-EdgeConfig.ps1 -Name "nft001a4i2 -1" -Path "C:\Scripts\CSE\EdgeXML\nft001a4i2 -1\nft001a4i2 -1_VPN_SR.xml"
